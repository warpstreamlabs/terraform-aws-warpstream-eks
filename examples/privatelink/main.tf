...
variable "warpstream_control_plane_private_link_url" {
  description = "The URL for the private link"
  type        = string

  # This will be shared by WarpStream Support
  default = "http://localhost"
}

variable "warpstream_control_plane_private_service_name" {
  description = "The service name for the private link"
  type        = string

  # This will be shared by WarpStream Support
  default = "com.amazonaws.vpce.us-east-1.vpce-svc-XXXXXXXXXXXX"
}
...
module "endpoints" {
  ...
  endpoints = {
    ...
    # WarpStream Private Link
    var.warpstream_control_plane_private_service_name = {
      service_name        = var.warpstream_control_plane_private_service_name
...
module "warpstream" {
  ...
  control_plane_region           = "" # Leaving region as empty since we are giving the private link URL
  control_plane_private_link_url = var.warpstream_control_plane_private_link_url
